...
{
	RodDirection += FVector2D( _input.Y * RodMoveSpeed, _input.X * RodMoveSpeed );
	RodDirection.X = FMath::Clamp( RodDirection.X, -1,0 );
	RodDirection.Y = FMath::Clamp( RodDirection.Y, -1,1 );
	return true;
}
